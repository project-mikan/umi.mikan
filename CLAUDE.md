...
The iOS app connects to the backend via `https://umi-mikan-api.usuyuki.net` (Cloudflare Tunnel) using TLS. See `adr/0012-ios-grpc-transport.md` for transport protocol decisions.
