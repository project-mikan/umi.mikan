		...
		<div class="flex-1 space-y-8 w-full md:w-auto">
			...
			>
				...
				{#if form?.error && isMessageForAction("updateUsername")}
					<div class="mt-3 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded {$autoPhraseEnabled ? 'auto-phrase' : ''}">
						{$_(`settings.messages.${form.error}`) || form.error}
					</div>
				{/if}
				{#if form?.success && isMessageForAction("updateUsername")}
					<div class="mt-3 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded {$autoPhraseEnabled ? 'auto-phrase' : ''}">
			...
			>
				...
				<div>
					...
					<p class="text-xs text-gray-500 dark:text-gray-400 mb-2 {$autoPhraseEnabled ? 'auto-phrase' : ''}">
					...
					<p class="text-xs text-orange-600 dark:text-orange-400 mb-2 bg-orange-50 dark:bg-orange-900/20 p-2 rounded border border-orange-200 dark:border-orange-800 {$autoPhraseEnabled ? 'auto-phrase' : ''}">
			...
			{/if}
				...
				<p class="text-gray-700 dark:text-gray-300 mb-4 {$autoPhraseEnabled ? 'auto-phrase' : ''}">
			...
			<div class="mb-4">
				<p class="text-gray-700 dark:text-gray-300 mb-2 {$autoPhraseEnabled ? 'auto-phrase' : ''}">
...
>
	<p class="text-sm text-gray-500 dark:text-gray-400 {$autoPhraseEnabled ? 'auto-phrase' : ''}">
...
>
	<p class="text-sm text-gray-500 dark:text-gray-400 mb-2 {$autoPhraseEnabled ? 'auto-phrase' : ''}">
		{$_("settings.deleteAccount.confirmMessage")}
	</p>
	<p class="text-sm text-red-600 dark:text-red-400 font-medium {$autoPhraseEnabled ? 'auto-phrase' : ''}">
		{$_("settings.deleteAccount.warning")}
	</p>
</Modal>