...
import type { DiaryServiceClient as _diary_DiaryServiceClient, DiaryServiceDefinition as _diary_DiaryServiceDefinition } from './diary/DiaryService';
...
export interface ProtoGrpcType {
  diary: {
    ...
    DiaryService: SubtypeConstructor<typeof grpc.Client, _diary_DiaryServiceClient> & { service: _diary_DiaryServiceDefinition }
